export const PORTFOLIO_DATA = {
  ...
  projects: [
    ...
    { id: 2, title: "Sanjeevani (AI HealthCare Assistant)", description: "Built an AI-powered healthcare assistant using Next.js, Tailwind CSS, Python, and Flask to analyze medicine strips and decipher handwritten prescriptions via the Groq API.", technologies: ["Next.js", "Flask", "Groq API", "Edge-TTS"], link: "https://github.com/VanshSharmaPES/Sanjeevani" },
    ...
    {id: 4, title: "Personal Portfolio", description: "A high-performance, responsive portfolio website built to showcase my projects and skills. Features smooth page transitions, strict type safety, and a modern dark-themed UI.", technologies: ["Next.js", "TypeScript", "Tailwind CSS", "Framer Motion"], link: "https://github.com/VanshSharmaPES/portfolio-app-full-stack"},
  ],
  contact: {
